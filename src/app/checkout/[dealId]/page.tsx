          ...
          <div className="lg:w-2/3 space-y-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-500 font-medium">
                Seleccioná el punto de retiro más cercano en tu barrio.
              </p>
            </div>
            ...
            <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100 divide-y divide-slate-50">
               <div className="flex items-start gap-5 pb-8">
                 <div className="w-12 h-12 rounded-2xl bg-[#E8F7FF] flex items-center justify-center shrink-0">
                   <Wallet className="text-[#00AEEF]" size={24} />
                 </div>
            ...
            <div className="bg-white rounded-[3rem] p-8 shadow-2xl shadow-slate-200/50 border border-slate-50 sticky top-24">
               ...
               <div className="flex gap-5 mb-8">
                 ...
                 <div>
                   ...
                   <span className="inline-flex text-[10px] font-black bg-[#E8F7FF] text-[#00AEEF] px-3 py-1 rounded-full uppercase tracking-widest ring-1 ring-[#00AEEF]/20">
                     OFERTA GRUPAL
                   </span>
                 </div>
               </div>
               ...
               <button
                  ...
                  className="w-full bg-[#00AEEF] hover:bg-[#0077CC] disabled:bg-slate-100 disabled:text-slate-300 disabled:cursor-not-allowed text-white font-black py-5 rounded-[2rem] shadow-xl shadow-[#00AEEF]/20 transition-all flex items-center justify-center gap-3 text-sm uppercase tracking-widest group mb-6 active:scale-[0.98]"
                >
