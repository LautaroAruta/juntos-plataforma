      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="bg-white rounded-[2rem] md:rounded-[3rem] shadow-sm border border-gray-100 overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="lg:w-2/5 p-6 md:p-10 lg:p-12 flex flex-col">
            ...
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-800 leading-[1.1] tracking-tighter mb-2">
              {product.nombre}
            </h1>

            <p className="text-[13px] font-bold text-gray-400 mb-8 flex items-center gap-1.5 uppercase tracking-wide">
              Vendido por <span className="text-[#009EE3]">
            ...
            <div className="mb-8">
              {activeDeal && (
                <div className="text-xs md:text-sm font-medium text-gray-400 line-through mb-1.5 ml-1">
                  ${originalPrice.toLocaleString()} individual
                </div>
              )}
              <div className="flex flex-nowrap items-center gap-3 bg-[#00A650]/5 border border-[#00A650]/15 px-5 py-4 rounded-[2rem] w-fit shadow-sm overflow-hidden ring-1 ring-[#00A650]/5">
                <span className="text-[clamp(1.5rem,5vw,2.5rem)] md:text-4xl font-black text-gray-900 tracking-tighter leading-none shrink-0 whitespace-nowrap">
              ...
              <p className="text-[12px] text-[#009EE3] font-bold mt-3 flex items-center gap-1.5 uppercase tracking-wide">
            ...
            {activeDeal && (
              <div className="bg-white rounded-[1.25rem] p-4 md:p-5 mb-8 border border-slate-100 shadow-[0_4px_20px_rgb(0,0,0,0.02)] relative overflow-hidden group/progress">
                <div className="flex flex-col gap-3 relative z-10">

                  {/* Fila Superior: Timer con Etiqueta */}
                  <div className="flex items-center gap-2">
                    <span className="text-sm md:text-base font-black text-slate-800 tracking-tighter uppercase shrink-0">
                      ¡FINALIZA EN:
                    </span>
                    <CountdownTimer
                  ...
                  <div className="space-y-2.5">
                    <div className="h-2.5 w-full bg-slate-100 rounded-full overflow-hidden relative shadow-inner">
                      <div
                        className="h-full bg-gradient-to-r from-[#00A650] via-[#00A650] to-[#009EE3] rounded-full transition-all duration-1000 ease-out relative overflow-hidden"
                    ...
                    <div className="flex items-center gap-2 text-[11px] font-bold text-slate-500 bg-[#E8F7FF]/20 py-1.5 px-3 rounded-lg border border-[#009EE3]/5 self-start">
                      <ShieldCheck size={13} className="text-[#009EE3] shrink-0" />
            ...
            <div className="hidden md:flex flex-col gap-4 mb-10 w-full mt-auto">
              <div className="flex flex-col gap-3">
                ...
                <button className="w-full py-4 bg-white hover:bg-gray-50 text-gray-500 font-bold rounded-2xl transition-all active:scale-95 flex items-center justify-center gap-2 border-2 border-gray-100 uppercase tracking-tight text-sm">
                  <span>Comprar Individual</span>
                  <span className="opacity-60">—</span>
                  <span className="font-black text-gray-700">${originalPrice.toLocaleString()}</span>
                </button>
              </div>
              ...
              <p className="text-[10px] font-bold text-center text-gray-300 uppercase tracking-widest mt-2">
