    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="prose prose-slate max-w-none text-gray-600 font-medium space-y-6">
          <p>
            Bienvenido a <strong>JUNTOS</strong>. Al utilizar nuestra plataforma, aceptás los siguientes términos que rigen la relación entre los vecinos compradores, 
            los proveedores y la plataforma.
          </p>

          <h2 className="text-xl font-bold text-gray-800 mt-8">1. Naturaleza del Servicio</h2>
          <p>
            JUNTOS es un punto de encuentro que facilita la <strong>compra colaborativa</strong>. La plataforma no vende productos directamente, 
          ...
          <p>
            ...
            esto perjudicaría el precio obtenido por el resto de los vecinos. Se aplican las garantías legales vigentes en Argentina.
          </p>

          <h2 className="text-xl font-bold text-gray-800 mt-8">5. Responsabilidad</h2>
          <p>
            JUNTOS garantiza la transparencia del proceso y el manejo seguro de los fondos, pero la calidad final del producto es responsabilidad 
