    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="prose prose-slate max-w-none text-gray-600 font-medium space-y-6">
          <p>Bienvenido a JUNTOS. Al utilizar nuestra plataforma, aceptas los siguientes términos...</p>
          <h2 className="text-xl font-bold text-gray-800 mt-8">1. Uso del Servicio</h2>
          <p>JUNTOS es un marketplace que facilita la compra grupal entre usuarios y proveedores.</p>
