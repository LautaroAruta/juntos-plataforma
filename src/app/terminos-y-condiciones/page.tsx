...
export default function LegalPage() {
  return (
    <div className="min-h-screen bg-bandha-bg">
      <div className="max-w-3xl mx-auto px-6 py-20">
        <Link href="/" className="inline-flex items-center gap-2 text-bandha-primary font-bold text-sm uppercase tracking-widest mb-12">
          <ArrowLeft size={16} /> Volver
        </Link>
        <h1 className="text-4xl font-black text-bandha-text tracking-tighter uppercase mb-12">Términos y Condiciones</h1>
        <div className="prose prose-slate dark:prose-invert max-w-none text-bandha-text-secondary font-medium space-y-6">
          <p>
          ...
          <h2 className="text-xl font-bold text-bandha-text mt-8">1. Naturaleza del Servicio</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-bandha-text mt-8">2. Ofertas Grupales (Quórum)</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-bandha-text mt-8">3. Retiro de Productos</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-bandha-text mt-8">4. Reembolsos y Cancelaciones</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-bandha-text mt-8">5. Responsabilidad</h2>
          <p>
