  ...
  return (
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-[2.5rem] p-10 shadow-2xl shadow-[#009EE3]/10 text-center border border-slate-50">
        ...
        <Link 
          href="/"
          className="w-full bg-[#009EE3] hover:bg-[#00A650] text-white font-black py-4 rounded-2xl shadow-xl shadow-[#009EE3]/20 transition-all flex items-center justify-center gap-2"
        >
