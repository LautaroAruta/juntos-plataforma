  ...
  return (
    <div className="min-h-screen bg-bandha-bg">
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <h1 className="text-4xl font-black text-bandha-text tracking-tighter uppercase mb-12">Política de Privacidad</h1>
        <div className="prose prose-slate dark:prose-invert max-w-none text-bandha-text-secondary font-medium space-y-6">
          ...
          <h2 className="text-xl font-bold text-bandha-text mt-8">1. Datos que recolectamos</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-bandha-text mt-8">2. Uso de la Información</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-bandha-text mt-8">3. Terceros</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-bandha-text mt-8">4. Tus Derechos</h2>
          <p>
            Podés solicitar el acceso, rectificación o supresión de tus datos en cualquier momento enviando un correo a 
            <a href="mailto:privacidad@bandha.com.ar" className="text-bandha-primary"> privacidad@bandha.com.ar</a>.
          </p>
        </div>
      </div>
    </div>
